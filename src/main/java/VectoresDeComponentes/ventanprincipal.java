...
public class ventanprincipal extends javax.swing.JFrame {
    ...
    public void btnAceptarActionPerformed(ActionEvent evt) { // Corregido: btnAcceptor -> btnAceptar
    int cont = 0;

    for (int i = 0; i < vcuadros.length; i++) { // Mejor declaración de 'i'
